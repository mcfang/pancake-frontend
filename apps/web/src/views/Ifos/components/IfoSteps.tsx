...
const Step1 = ({ hasProfile }: { hasProfile: boolean }) => {
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <Box>
      <Text>
        {t(
          'The number of iVE equals the locked staking amount if the staking duration is longer than %weeks% weeks. If the staking duration is less than %weeks% weeks, it will linearly decrease based on the staking duration.',
          {
            weeks: weeksDisplay,
          },
        )}
  ...
  return (
    <CardBody>
      ...
      <Heading as="h4" color="secondary" mb="16px">
        {t('Lock VE in the VE pool')}
      </Heading>
      <Box>
        <Text mb="4px" color="textSubtle" small>
          {t(
            'The maximum amount of VE you can commit to the Public Sale equals the number of your iVE. Lock more VE for longer durations to increase the maximum VE you can commit to the sale.',
          )}
        </Text>
        <TooltipText as="span" fontWeight={700} ref={targetRef} color="textSubtle" small>
          {t('How does the number of iVE calculated?')}
        </TooltipText>
        <Text mt="4px" color="textSubtle" small>
          {t(
            'Missed this LaunchPad? You will enjoy the same amount of iVE for future LaunchPad if your locked-staking position is not unlocked.',
          )}
        </Text>
      </Box>
      {hasProfile && (
  ...
  return (
    <CardBody>
      ...
      <Text color="textSubtle" small>
        {t(
          'Please note that VE in the fixed-term staking positions will remain locked and can not be used for committing to LaunchPad sales. You will need a separate amount of VE in your wallet balance to commit to the LaunchPad sales.',
        )}{' '}
        <br />
      </Text>
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active ViewExchange Profile to take part in an LaunchPad!')}
            </Text>
            {renderAccountStatus()}
          </CardBody>
        )
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the LaunchPad sales finish, you can claim any LaunchPad tokens that you bought, and any unspent VE tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
  ...
  return (
    <Wrapper>
      <Heading id="ifo-how-to" as="h2" scale="xl" color="secondary" mb="24px" textAlign="center">
        How to Take Part in the LaunchPad
      </Heading>
      <Stepper>
